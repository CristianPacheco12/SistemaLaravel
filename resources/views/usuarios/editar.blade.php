...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading" style="color:#000;">Editar Usuario</h3>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="email"  style="display: inline-block;  color: #000; font-size: 15px;">E-mail</label><span class="required text-danger">*</span>
