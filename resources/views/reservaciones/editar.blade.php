                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ url('reservaciones/' . ($reservacion ? $reservacion->id : '')) }}" method="POST">
    @csrf
     @method('POST')
                                <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="numero_personas" class="form-control">
                                            @for ($i = 1; $i <= 60; $i++)
                                                <option value="{{ $i }}" {{ $i == $reservacion->numero_personas ? 'selected' : '' }}>{{ $i }}</option>
                                            @endfor
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telefono" class="form-control" pattern="[0-9]*" oninput="validity.valid||(value='');" value="{{ old('telefono', $reservacion->telefono) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fecha_entrada" id="fecha_entrada" class="form-control" onchange="actualizarCampoFecha()" min="{{ now()->format('Y-m-d') }}" max="{{ now()->addYear()->format('Y-m-d') }}" value="{{ old('fecha_entrada', optional($reservacion->fecha_entrada)->format('Y-m-d')) }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="fecha_salida" id="fecha_salida" class="form-control" onchange="actualizarCampoFecha()" min="{{ now()->format('Y-m-d') }}" max="{{ now()->addYear()->format('Y-m-d') }}" value="{{ old('fecha_salida', optional($reservacion->fecha_salida)->format('Y-m-d')) }}">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <table class="table">
                                            ...
                                            @foreach($cabanasDisponibles as $cabana)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" name="cabanas_seleccionadas[]" value="{{ $cabana->nombre }}" {{ $reservacion->cabanas->contains('nombre', $cabana->nombre) ? 'checked' : '' }}>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
